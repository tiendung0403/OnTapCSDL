...
## 🔹 1. Nhóm hàm ngày tháng (Date & Time)
| Hàm | Chức năng | Ví dụ |
|------|----------|-------|
...
## 🔹 2. Nhóm hàm xử lý chuỗi (String Functions)
| Hàm | Chức năng | Ví dụ |
|------|----------|-------|
...
## 🔹 3. Nhóm hàm toán học (Math Functions)
| Hàm | Chức năng | Ví dụ |
|------|----------|-------|
...
## 🔹 4. Nhóm hàm tổng hợp (Aggregate Functions)
| Hàm | Chức năng | Ví dụ |
|------|----------|-------|
...
## 🔹 5. Nhóm hàm điều kiện (Conditional Functions)
| Hàm | Chức năng | Ví dụ |
|------|----------|-------|
